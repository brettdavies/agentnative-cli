...
flowchart LR
    ...
    CLI -->|site's regen-scorecards.sh<br/>(anc inspect ... --output json)| SITE_SCORE
...
3. **Manual** — if the registry shape or covers map changed, run `anc render coverage-matrix` and commit
