//! Audit: Detect structured error types in Rust source.
//!
...
//!
//! This is a presence audit: pass if any enum with "Error" in its name exists.
...
/// Audit whether a source string contains an enum whose name includes "Error".
///
