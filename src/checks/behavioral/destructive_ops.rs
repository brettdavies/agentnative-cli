//! Shared destructive-operation classification for the P5 checks.
//!
//! Two checks need the same list of "destructive" subcommand verbs and the
//! complementary "read" verbs. Centralizing keeps the rubric consistent: if
//! a new verb is added (or a false-positive trimmed), both checks update at
//! once.
...
/// distinction check to confirm the CLI ships both surfaces. Case-insensitive
