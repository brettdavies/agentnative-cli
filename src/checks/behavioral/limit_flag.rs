...
pub struct LimitFlagCheck;

impl Check for LimitFlagCheck {
    fn id(&self) -> &str {
        "p7-limit"
    }
    ...
    fn run(&self, project: &Project) -> anyhow::Result<CheckResult> {
        let status = match project.help_output() {
            ...
            Some(help) => check_limit_flag(help),
        };
...
pub(crate) fn check_limit_flag(help: &HelpOutput) -> CheckStatus {
...
mod tests {
    ...
    fn pass_when_list_and_limit_present() {
        ...
        assert_eq!(check_limit_flag(&help), CheckStatus::Pass);
    }
    ...
    fn warn_when_list_without_limit() {
        ...
        match check_limit_flag(&help) {
            CheckStatus::Warn(msg) => assert!(msg.contains("--limit")),
