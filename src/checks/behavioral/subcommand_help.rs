//! Shared subcommand-help recursion for the P3/P6 example checks.
//!
//! Three behavioral checks need to probe `<bin> <subcmd> --help` for every
//! top-level subcommand and inspect the result. This module centralizes the
//! recursion so the three checks share probe results (via the runner cache)
